...
public class ManageV4 {
    public OperatorV1 operatorV1 =new OperatorV1();
    ...
    private void addBook(){
        ...
        if(operatorV1.addBook(name,author,price)){
    ...
    private void deleteBookByName(){
        ...
        if(operatorV1.deleteBookByName(name)){
    ...
    private void deleteBookByAuthor(){
        System.out.println("Enter the author of the book:");
        String name=stringScanner.nextLine();
        if(operatorV1.deleteBookByAuthor(name)){
            System.out.println("delete success");
        }else {
            System.out.println("delete fail");
        }
    ...
    private void modifyBook(){
        ...
        System.out.println("Enter the price of the book:");
        float price=digitalScanner.nextFloat();
        if(operatorV1.modifyBook(newName,author,price,name)){
    ...
    private void searchBook(){
       ...
       ResultSet resultSet= operatorV1.searchBook(name);
        if(resultSet!=null) {
            try {
    ...
    private void printBooks(){
        ResultSet resultSet= operatorV1.printBook();
        if (resultSet!=null) {
            try {
                while (resultSet.next()) {
                    // 通过字段检索
