...
public class DBConnection {
    ...
    private String sql1="SELECT bookId, bookName, author,price FROM book Where bookName=? OR author=? OR price between ? AND ?";
    ...
    public void setSelectStatement(String bookName,String author,float lowerPrice,float upperPrice) throws SQLException {
        selectStatement.setString(1,bookName);
        selectStatement.setString(2,author);
        selectStatement.setFloat(3,lowerPrice);
        selectStatement.setFloat(4,upperPrice);
    }
